...
parser.add_argument('--dataset', default=str('mnist'), help='cifar10 | lsun | mnist |imagenet | folder | lfw | fake')
parser.add_argument('--dataroot', default=str('./'), help='path to dataset')
